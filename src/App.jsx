...
function CreateFlow() {
  ...
  const createFlow = (treeData) => {
    ...
    const CREATE_FLOW_API = `https://auto-web-server-7ko8h.ondigitalocean.app/flow/create`;
...
function ViewFlow() {
  ...
  const getFlowById = () => {
    ...
    const PROCESS_LIST_API = `https://auto-web-server-7ko8h.ondigitalocean.app/flow/id`;
    fetch(PROCESS_LIST_API, options)
      .then((response) => {
        return response.json();
      })
